...
function Library:CreateWindow()
    ...
    HeaderTitle.Text = "<b>Minecraft</b> <font color=\"#008000\">Hub</font> <font color=\"#555555\" size=\"12\">" .. Version .. "</font>"
...
local PlayerModule = LoadModule("Player")
if PlayerModule and PlayerModule.Init then PlayerModule.Init(PlayerTab) end
